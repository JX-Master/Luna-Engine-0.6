...
namespace luna
{
	...
	struct alignas(16) Float2
	{
		...
		constexpr explicit Float2(float32 _x) :
			x(_x), y(_x) {}
		constexpr Float2(float32 _x, float32 _y) :
			x(_x), y(_y) {}
		explicit Float2(const float32* pArray)
		{
			x = pArray[0];
			y = pArray[1];
		}
	...
	static_assert(sizeof(Float2) == sizeof(float32) * 4, "Incorrect Float2 size.");

	Float2 operator+ (const Float2& v1, const Float2& v2);
	Float2 operator- (const Float2& v1, const Float2& v2);
	Float2 operator* (const Float2& v1, const Float2& v2);
	Float2 operator/ (const Float2& v1, const Float2& v2);
	Float2 operator+ (const Float2& v, float32 s);
	Float2 operator+ (float32 s, const Float2& v);
	Float2 operator- (const Float2& v, float32 s);
	Float2 operator- (float32 s, const Float2& v1);
	Float2 operator* (const Float2& v, float32 s);
	Float2 operator* (float32 s, const Float2& v);
	Float2 operator/ (const Float2& v, float32 s);
	Float2 operator/ (float32 s, const Float2& v);
	...
	float32 length(const Float2& vec);
	float32 length_squared(const Float2& vec);
	float32 dot(const Float2& vec1, const Float2& vec2);
	...
	float32 distance(const Float2& vec1, const Float2& vec2);
	float32 distance_squared(const Float2& vec1, const Float2& vec2);
	Float2 min(const Float2& vec1, const Float2& vec2);
	Float2 max(const Float2& vec1, const Float2& vec2);
	Float2 lerp(const Float2& vec1, const Float2& vec2, float32 t);
	Float2 smoothstep(const Float2& vec1, const Float2& vec2, float32 t);
	Float2 barycentric(const Float2& vec1, const Float2& vec2, const Float2& vec3, float32 f, float32 g);
	Float2 catmull_rom(const Float2& vec1, const Float2& vec2, const Float2& vec3, const Float2& vec4, float32 t);
	Float2 hermite(const Float2& vec1, const Float2& t1, const Float2& vec2, const Float2& t2, float32 t);
	Float2 reflect(const Float2& ivec, const Float2& nvec);
	Float2 refract(const Float2& ivec, const Float2& nvec, float32 refractionIndex);
	...
	struct Vec2U
	{
		...
		{
			return Float2((float32)x, (float32)y);
		}
	...
	using Float2U = Vec2U<float32>;
	using Int2U = Vec2U<int32>;
	using UInt2U = Vec2U<uint32>;
	...
	struct alignas(16) Float3
	{
		...
		constexpr explicit Float3(float32 _x) :
			x(_x), y(_x), z(_x) {}
		constexpr Float3(float32 _x, float32 _y, float32 _z) :
			x(_x), y(_y), z(_z) {}
		explicit Float3(const float32* pArray)
		{
			x = pArray[0];
			y = pArray[1];
			z = pArray[2];
	...
	static_assert(sizeof(Float3) == sizeof(float32) * 4, "Incorrect Float2 size.");

	Float3 operator+ (const Float3& v1, const Float3& v2);
	Float3 operator- (const Float3& v1, const Float3& v2);
	Float3 operator* (const Float3& v1, const Float3& v2);
	Float3 operator/ (const Float3& v1, const Float3& v2);
	Float3 operator+ (const Float3& v, float32 s);
	Float3 operator+ (float32 s, const Float3& v);
	Float3 operator- (const Float3& v, float32 s);
	Float3 operator- (float32 s, const Float3& v);
	Float3 operator* (const Float3& v, float32 s);
	Float3 operator* (float32 s, const Float3& v);
	...
	float32 length(const Float3& vec);
	float32 length_squared(const Float3& vec);
	float32 dot(const Float3& vec1, const Float3& vec2);
	...
	float32 distance(const Float3& vec1, const Float3& vec2);
	float32 distance_squared(const Float3& vec1, const Float3& vec2);
	Float3 min(const Float3& vec1, const Float3& vec2);
	Float3 max(const Float3& vec1, const Float3& vec2);
	Float3 lerp(const Float3& vec1, const Float3& vec2, float32 t);
	Float3 smoothstep(const Float3& vec1, const Float3& vec2, float32 t);
	Float3 barycentric(const Float3& vec1, const Float3& vec2, const Float3& vec3, float32 f, float32 g);
	Float3 catmull_rom(const Float3& vec1, const Float3& vec2, const Float3& vec3, const Float3& vec4, float32 t);
	Float3 hermite(const Float3& vec1, const Float3& t1, const Float3& vec2, const Float3& t2, float32 t);
	Float3 reflect(const Float3& ivec, const Float3& nvec);
	Float3 refract(const Float3& ivec, const Float3& nvec, float32 refractionIndex);
	...
	struct Vec3U
	{
		...
		{
			return Float3((float32)x, (float32)y, (float32)z);
		}
	...
	using Float3U = Vec3U<float32>;
	using Int3U = Vec3U<int32>;
	using UInt3U = Vec3U<uint32>;
	...
	struct alignas(16) Float4
	{
		...
		constexpr explicit Float4(float32 _x) :
			x(_x), y(_x), z(_x), w(_x) {}
		constexpr Float4(float32 _x, float32 _y, float32 _z, float32 _w) :
			x(_x), y(_y), z(_z), w(_w) {}
		explicit Float4(const float32* pArray)
		{
			x = pArray[0];
			y = pArray[1];
			z = pArray[2];
	...
	Float4 operator* (const Float4& v1, const Float4& v2);
	Float4 operator/ (const Float4& v1, const Float4& v2);
	Float4 operator+ (const Float4& v, float32 s);
	Float4 operator+ (float32 s, const Float4& v);
	Float4 operator- (const Float4& v, float32 s);
	Float4 operator- (float32 s, const Float4& v);
	Float4 operator* (const Float4& v, float32 s);
	Float4 operator* (float32 s, const Float4& v);
	...
	float32 length(const Float4& vec);
	float32 length_squared(const Float4& vec);
	float32 dot(const Float4& vec1, const Float4& vec2);
	...
	float32 distance(const Float4& vec1, const Float4& vec2);
	float32 distance_squared(const Float4& vec1, const Float4& vec2);
	Float4 min(const Float4& vec1, const Float4& vec2);
	Float4 max(const Float4& vec1, const Float4& vec2);
	Float4 lerp(const Float4& vec1, const Float4& vec2, float32 t);
	Float4 smoothstep(const Float4& vec1, const Float4& vec2, float32 t);
	Float4 barycentric(const Float4& vec1, const Float4& vec2, const Float4& vec3, float32 f, float32 g);
	Float4 catmull_rom(const Float4& vec1, const Float4& vec2, const Float4& vec3, const Float4& vec4, float32 t);
	Float4 hermite(const Float4& vec1, const Float4& t1, const Float4& vec2, const Float4& t2, float32 t);
	Float4 reflect(const Float4& ivec, const Float4& nvec);
	Float4 refract(const Float4& ivec, const Float4& nvec, float32 refractionIndex);
	...
	struct Vec4U
	{
		...
		{
			return Float4((float32)x, (float32)y, (float32)z, (float32)w);
		}
	...
	using Float4U = Vec4U<float32>;
	using Int4U = Vec4U<int32>;
	using UInt4U = Vec4U<uint32>;
	...
	inline Float2 & Float2::operator+=(float32 s)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float2a(m);
		vec_float_t v2 = VectorReplicate(s);
		v2 = VectorAdd(v1, v2);
		store_float2a(m, v2);
		return *this;
#else
	...
	inline Float2 operator+(const Float2 & v1, float32 s)
	{
		return Float2(v1.x + s, v1.y + s);
	}

	inline Float2 operator+(float32 s, const Float2 & v1)
	{
		return Float2(v1.x + s, v1.y + s);
	}
	...
	inline Float2 operator* (const Float2& V, float32 S)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
	...
	inline Float2 operator* (float32 S, const Float2& V)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float2a(V.m);
...
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = VectorReplicate(s);
	...
	inline float32 length(const Float2& vec)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float2a(vec.m);
	...
	inline float32 length_squared(const Float2& vec)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float2a(vec.m);
	...
	inline float32 dot(const Float2& v1, const Float2& v2)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t vec1 = load_float2a(v1.m);
	...
	inline Float2 cross(const Float2& v1, const Float2& v2)
	{
		...
		return result;
#else
		float32 fCross = v1.x * v2.y - v1.y * v2.x;
		Float2 result;
		result.x = fCross;
		result.y = fCross;
		return result;
	...
	inline float32 distance(const Float2& v1, const Float2& v2)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		...
		return VectorGetX(X);
#else
		float32 delX = v1.x - v2.x;
		float32 delY = v1.y - v2.y;
		return sqrtf(delX * delX + delY * delY);
#endif
	}

	inline float32 distance_squared(const Float2& v1, const Float2& v2)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float2a(v1.m);
	...
	inline Float2 lerp(const Float2& v1, const Float2& v2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float2a(v1.m);
	...
	inline Float2 smoothstep(const Float2& v1, const Float2& v2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
	...
	inline Float2 barycentric(const Float2& v1, const Float2& v2, const Float2& v3, float32 f, float32 g)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float2a(v1.m);
	...
	inline Float2 catmull_rom(const Float2& v1, const Float2& v2, const Float2& v3, const Float2& v4, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float2a(v1.m);
	...
	inline Float2 hermite(const Float2& v1, const Float2& t1, const Float2& v2, const Float2& t2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float2a(v1.m);
	...
	inline Float2 refract(const Float2& ivec, const Float2& nvec, float32 refractionIndex)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t i = load_float2a(ivec.m);
	...
	inline Float3& Float3::operator+=(float32 s)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float3a(m);
	...
	inline Float3 operator+(const Float3& v, float32 s)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
	...
	inline Float3 operator+(float32 s, const Float3 & v)
	{
		return v + s;
	}
	...
	inline float32 length(const Float3& vec)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float3a(vec.m);
	...
	inline float32 length_squared(const Float3& vec)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float3a(vec.m);
	...
	inline float32 dot(const Float3& v1, const Float3& v2)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t vec1 = load_float3a(v1.m);
	...
	inline float32 distance(const Float3& v1, const Float3& v2)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		...
		float32 delX = v1.x - v2.x;
		float32 delY = v1.y - v2.y;
		float32 delZ = v1.z - v2.z;
		return sqrtf(delX * delX + delY * delY + delZ * delZ);
#endif
	}

	inline float32 distance_squared(const Float3& v1, const Float3& v2)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float3a(v1.m);
	...
	inline Float3 lerp(const Float3& v1, const Float3& v2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float3a(v1.m);
	...
	inline Float3 smoothstep(const Float3& v1, const Float3& v2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		t = (t > 1.0f) ? 1.0f : ((t < 0.0f) ? 0.0f : t);  // Clamp value to 0 to 1
	...
	inline Float3 barycentric(const Float3& v1, const Float3& v2, const Float3& v3, float32 f, float32 g)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float3a(v1.m);
	...
	inline Float3 catmull_rom(const Float3& v1, const Float3& v2, const Float3& v3, const Float3& v4, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float3a(v1.m);
	...
	inline Float3 hermite(const Float3& v1, const Float3& t1, const Float3& v2, const Float3& t2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t x1 = load_float3a(v1.m);
...
#else
		Float3 result;
		float32 s = 2.0f * (ivec.x * nvec.x + ivec.y * nvec.y + ivec.z * nvec.z);
	...
	inline Float3 refract(const Float3& ivec, const Float3& nvec, float32 refraction_index)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t i = load_float3a(ivec.m);
		...
		return result;
#else
		float32 t = (ivec.x * nvec.x + ivec.y * nvec.y + ivec.z * nvec.z);
		float32 r = 1.0f - refraction_index * refraction_index * (1.0f - t * t);
		Float3 result;
		...
		{
			float32 s = refraction_index * t + sqrtf(r);
	...
	inline Float4 & Float4::operator+=(float32 s)
	{
#ifdef LUNA_SIMD_ENABLED
		using namespace simd;
		vec_float_t v1 = load_float4a(m);
	...
	inline Float4 operator+(const Float4& v, float32 s)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd;
	...
	inline Float4 operator+(float32 s, const Float4& v)
	{
		return v + s;
	}
	...
	inline float32 length(const Float4& vec)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t v1 = load_float4a(vec.m);
	...
	inline float32 length_squared(const Float4& vec)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t v1 = load_float4a(vec.m);
	...
	inline float32 dot(const Float4& v1, const Float4& v2)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t vec1 = load_float4a(v1.m);
	...
	inline float32 distance(const Float4& v1, const Float4& v2)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t x1 = load_float4a(v1.m);
		...
		float32 delY = v1.y - v2.y;
		float32 delZ = v1.z - v2.z;
		float32 delW = v1.w - v2.w;
		return sqrtf(delX * delX + delY * delY + delZ * delZ + delW * delW);
#endif
	}

	inline float32 distance_squared(const Float4& v1, const Float4& v2)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t x1 = load_float4a(v1.m);
	...
	inline Float4 lerp(const Float4& v1, const Float4& v2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t x1 = load_float4a(v1.m);
	...
	inline Float4 smoothstep(const Float4& v1, const Float4& v2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		t = (t > 1.0f) ? 1.0f : ((t < 0.0f) ? 0.0f : t);  // Clamp value to 0 to 1
	...
	inline Float4 barycentric(const Float4& v1, const Float4& v2, const Float4& v3, float32 f, float32 g)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t x1 = load_float4a(v1.m);
	...
	inline Float4 catmull_rom(const Float4& v1, const Float4& v2, const Float4& v3, const Float4& v4, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t x1 = load_float4a(v1.m);
	...
	inline Float4 hermite(const Float4& v1, const Float4& t1, const Float4& v2, const Float4& t2, float32 t)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t x1 = load_float4a(v1.m);
...
#else
		Float4 result;
		float32 s = 2.0f * (ivec.x * nvec.x + ivec.y * nvec.y + ivec.z * nvec.z + ivec.w * nvec.w);
		result.x = ivec.x - s * nvec.x;
		result.y = ivec.y - s * nvec.y;
		result.z = ivec.z - s * nvec.z;
	...
	inline Float4 refract(const Float4& ivec, const Float4& nvec, float32 refractionIndex)
	{
#ifdef LUNA_SIMD_ENABLED 
		using namespace simd; 
		vec_float_t i = load_float4a(ivec.m);
		...
		return result;
#else
		float32 t = (ivec.x * nvec.x + ivec.y * nvec.y + ivec.z * nvec.z + ivec.w * nvec.w);
		float32 r = 1.0f - refractionIndex * refractionIndex * (1.0f - t * t);
		Float4 result;
		if (r < 0.0f) // Total internal reflection
		{
			result.x = 0.0f;
		...
		{
			float32 s = refractionIndex * t + sqrtf(r);
