...
//------------------------------------------ Config CPU ------------------------------------------
    ...
    #else
        #error Unsupported CPU was used.
    #endif
#endif

#ifndef LUNA_MANUAL_CONFIG_CPU_TRAITS
    #if defined(__AVX__)
        #define LUNA_PLATFORM_AVX
    #endif
    #if defined(__AVX2__)
        #define LUNA_PLATFORM_AVX2
    #endif
	...
	#define LUNA_PLATFORM_VERSION_WIN10	0x0A00
...
#ifndef LUNA_MANUAL_CONFIG_CPP_STANDARD_VERSION
        ...
        #if (LUNA_COMPILER_VERSION >= 1925)
            #define LUNA_COMPILER_CPP20
        #endif
		#if (LUNA_COMPILER_VERSION >= 1910)
			#define LUNA_COMPILER_CPP17
		#endif
        #if (LUNA_COMPILER_VERSION >= 1900)
			#define LUNA_COMPILER_CPP14
        #endif
    #else
