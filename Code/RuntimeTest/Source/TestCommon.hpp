...
namespace Luna
{
	...
	struct TestObject
	{
		i32         m_value;              // Value for the TestObject.
		u32        m_magic;	            // Used to verify that an instance is valid and that it is not corrupted. It should always be kMagicValue.
		i64         m_id;                 // Unique id for each object, equal to its creation number. This value is not coped from other TestObjects during any operations, including moves.
		bool          m_throw_on_copy;      // Throw an exception of this object is copied, moved, or assigned to another.
		static i64  g_count;		        // Count of all current existing TestObjects.
		static i64  g_ctor_count;         // Count of times any ctor was called.
		static i64  g_dtor_count;		    // Count of times dtor was called.
		static i64  g_default_ctor_count; // Count of times the default ctor was called.
		static i64  g_arg_ctor_count;     // Count of times the x0,x1,x2 ctor was called.
		static i64  g_copy_ctor_count;    // Count of times copy ctor was called.
		static i64  g_move_ctor_count;    // Count of times move ctor was called.
		static i64  g_copy_assign_count;  // Count of times copy assignment was called.
		static i64  g_move_assign_count;  // Count of times move assignment was called.
