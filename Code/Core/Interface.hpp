...
#define luqitem(_ret_object, ...) \
		if(Impl::query_interface_raw<__VA_ARGS__>(iid, obj, _ret_object).valid())	\
		{	\
			return RV();	\
		}
#define luqdef()	\
