...
namespace luna
{
	namespace edraw
	{
		...
		struct IDrawList : public IObject
		{
			...
			virtual void set_rotation(float32 degrees) = 0;

			//! Gets the rotation for the following draw calls.
			virtual float32 get_rotation() = 0;
			...
			virtual void draw_triangle_list(uint32 num_vertices, const PrimitiveVertex* vertices,
				uint32 num_indices, const uint32* indices) = 0;
			...
			virtual R<TextDrawResult> draw_text(const char* text, const Float2& top_left, const Float2& region_size, 
				const Color& col = color::white, const Float2& spacing = Float2(0.0f, 0.0f)) = 0;

			//! Draws a filled triangle.
			virtual void draw_triangle_filled(const Float2& p1, const Float2& p2, const Float2& p3, const Color& col, bool antialiased = true) = 0;

			//! Draws a bordered triangle.
			virtual void draw_triangle_bordered(const Float2& p1, const Float2& p2, const Float2& p3, const Color& col, float32 line_width, bool antialiased = true) = 0;

			//! Draws a filled rectangle.
			virtual void draw_rectangle_filled(const Float2& top_left, const Float2& size, const Color& col) = 0;

			//! Draws a bordered rectangle.
			virtual void draw_rectangle_bordered(const Float2& top_left, const Float2& size, const Color& col, float32 line_width) = 0;

			//! Draws a filled circle.
			virtual void draw_circle_filled(const Float2& center, float32 radius, const Color& col, bool antialiased = true, uint32 num_segments = 16) = 0;

			//! Draws a bordered circle.
			virtual void draw_circle_bordered(const Float2& center, float32 radius, const Color& col, float32 line_width, bool antialiased = true, uint32 num_segments = 16) = 0;

			//! Draws a filled rounded edge rect.
			virtual void draw_rounded_rectangle_filled(const Float2& top_left, const Float2& size, const Color& col, float32 round_radius, bool antialiased = true) = 0;

			//! Draws a bordered round edge rect.
			virtual void draw_rounded_rectangle_bordered(const Float2& top_left, const Float2& size, const Color& col, float32 round_radius, float32 line_width, bool antialiased = true) = 0;

			//! Draws a line.
			virtual void draw_line(const Float2& pos1, const Float2& pos2, const Color& col, float32 line_width, bool antialiased = true) = 0;

			//! Draws an image.
			virtual void draw_texture(const Float2& top_left, const Float2& size, const Color& tint, gfx::IResource* tex, gfx::EResourceState state, const Float2& top_left_uv = Float2(0.0f, 0.0f), const Float2& bottom_right_uv = Float2(1.0f, 1.0f)) = 0;

			//! Get the number of draw calls currently stored in the draw list.
			virtual uint32 count_draw_calls() = 0;

			//! Enumerates draw calls.
			//! @param[in] index The index to enumerate. This must be in range [0, count_draw_calls()),
			//! or the behavior is undefined.
			virtual void enum_draw_call(uint32 index, DrawCall& dc) = 0;
		};
	}
}