...
namespace Luna
{
	namespace Gfx
	{
		...
		struct ResourceDesc
		{
			...
			static inline ResourceDesc buffer(EAccessType access_type, EResourceUsageFlag usages, u64 size)
			{
				ResourceDesc d;
				d.width = size;
			...
			static inline ResourceDesc tex1d(EResourceFormat format, EAccessType access_type, EResourceUsageFlag usages, u64 width, u32 array_size = 1, u32 mip_levels = 0)
			{
				ResourceDesc d;
				d.width = width;
			...
			static inline ResourceDesc tex2d(EResourceFormat format, EAccessType access_type, EResourceUsageFlag usages, u32 width, u32 height, u32 array_size = 1, u32 mip_levels = 0,
				u32 sample_count = 1, u32 sample_quality = 0)
			{
				ResourceDesc d;
				d.width = width;
			...
			static inline ResourceDesc tex3d(EResourceFormat format, EAccessType access_type, EResourceUsageFlag usages, u32 width, u32 height, u32 depth, u32 mip_levels = 0)
			{
				ResourceDesc d;
				d.width = width;
		...
		struct IResource : public IGraphicDeviceChild
		{
			...
			virtual EResourceState global_state(u32 subresource) = 0;
			...
			//! If `read_full_range` is `true`, this parameter is ignored.
			virtual R<void*> map_subresource(u32 subresource, bool read_full_range, usize read_range_begin = 0, usize read_range_end = 0) = 0;
			...
			//! If `write_full_range` is `true`, this parameter is ignored.
			virtual void unmap_subresource(u32 subresource, bool write_full_range, usize write_range_begin = 0, usize write_range_end = 0) = 0;
