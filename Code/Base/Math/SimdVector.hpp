...
#define LUNA_SIMD_3PACK4INTO3(v2x) \
    ...
    V3 = _mm_shuffle_ps(V3,V4,_MM_SHUFFLE(2,1,2,0));\
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorZero()
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSet
		(
			float32 x,
			float32 y,
			float32 z,
		...
		)
		{
			...
			float32x2_t V0 = vcreate_f32(
				static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&x))
				| (static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&y)) << 32));
			float32x2_t V1 = vcreate_f32(
				static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&z))
				| (static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&w)) << 32));
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetInt
		(
			uint32 x,
			uint32 y,
			uint32 z,
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorReplicate
		(
			float32 Value
		)
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorReplicatePtr
		(
			const float32* pValue
		)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorReplicateInt
		(
			uint32 Value
		)
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorReplicateIntPtr
		(
			const uint32 *pValue
		)
		{
...
#elif defined(LUNA_PLATFORM_SSE2)
			return _mm_load_ps1(reinterpret_cast<const float32 *>(pValue));
#endif
		}

		//------------------------------------------------------------------------------
		// Initialize a vector with all bits set (true mask)
		inline vec_float_t LUNA_SIMD_CALLCONV VectorTrueInt()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorFalseInt()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatX
		(
			vec_float_p1_t V
		)
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatY
		(
			vec_float_p1_t V
		)
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatZ
		(
			vec_float_p1_t V
		)
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatW
		(
			vec_float_p1_t V
		)
		{
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatOne()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatInfinity()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatQNaN()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatEpsilon()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSplatSignMask()
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline float32 LUNA_SIMD_CALLCONV VectorGetByIndex(vec_float_p1_t V, size_t i)
		{
			luassert(i < 4);
			vec_f32_t U;
			U.v = V;
		...
		inline float32 LUNA_SIMD_CALLCONV VectorGetX(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline float32 LUNA_SIMD_CALLCONV VectorGetY(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline float32 LUNA_SIMD_CALLCONV VectorGetZ(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline float32 LUNA_SIMD_CALLCONV VectorGetW(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		// Store a component indexed by i into a 32 bit float32 location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetByIndexPtr(float32 *f, vec_float_p1_t V, size_t i)
		{
			luassert(f != nullptr);
			luassert(i < 4);
			vec_f32_t U;
		...
		// Store the X component into a 32 bit float32 location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetXPtr(float32 *x, vec_float_p1_t V)
		{
			luassert(x != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		// Store the Y component into a 32 bit float32 location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetYPtr(float32 *y, vec_float_p1_t V)
		{
			luassert(y != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		// Store the Z component into a 32 bit float32 location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetZPtr(float32 *z, vec_float_p1_t V)
		{
			luassert(z != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		// Store the W component into a 32 bit float32 location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetWPtr(float32 *w, vec_float_p1_t V)
		{
			luassert(w != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		// function to use due to performance loss.
		inline uint32 LUNA_SIMD_CALLCONV VectorGetIntByIndex(vec_float_p1_t V, size_t i)
		{
			luassert(i < 4);
			vec_u32_t U;
			U.v = V;
		...
		inline uint32 LUNA_SIMD_CALLCONV VectorGetIntX(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline uint32 LUNA_SIMD_CALLCONV VectorGetIntY(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vgetq_lane_u32(V, 1);
#elif defined(LUNA_PLATFORM_SSE4)
			__m128i V1 = _mm_castps_si128(V);
			return static_cast<uint32>(_mm_extract_epi32(V1, 1));
#elif defined(LUNA_PLATFORM_SSE2)
			__m128i vResulti = _mm_shuffle_epi32(_mm_castps_si128(V), _MM_SHUFFLE(1, 1, 1, 1));
			return static_cast<uint32>(_mm_cvtsi128_si32(vResulti));
#endif
		}

		// Return the Z component in an integer register. 
		inline uint32 LUNA_SIMD_CALLCONV VectorGetIntZ(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vgetq_lane_u32(V, 2);
#elif defined(LUNA_PLATFORM_SSE4)
			__m128i V1 = _mm_castps_si128(V);
			return static_cast<uint32>(_mm_extract_epi32(V1, 2));
#elif defined(LUNA_PLATFORM_SSE2)
		...
		inline uint32 LUNA_SIMD_CALLCONV VectorGetIntW(vec_float_p1_t V)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vgetq_lane_u32(V, 3);
#elif defined(LUNA_PLATFORM_SSE4)
			__m128i V1 = _mm_castps_si128(V);
			return static_cast<uint32>(_mm_extract_epi32(V1, 3));
#elif defined(LUNA_PLATFORM_SSE2)
		...
		inline void LUNA_SIMD_CALLCONV VectorGetIntByIndexPtr(uint32 *x, vec_float_p1_t V, size_t i)
		{
			luassert(x != nullptr);
			luassert(i < 4);
			vec_u32_t U;
		...
		inline void LUNA_SIMD_CALLCONV VectorGetIntXPtr(uint32 *x, vec_float_p1_t V)
		{
			luassert(x != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
			vst1q_lane_u32(x, *reinterpret_cast<const uint32x4_t*>(&V), 0);
#elif defined(LUNA_PLATFORM_SSE2)
			_mm_store_ss(reinterpret_cast<float32 *>(x), V);
#endif
		}

		// Store the Y component into a 32 bit integer location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetIntYPtr(uint32 *y, vec_float_p1_t V)
		{
			luassert(y != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
...
#elif defined(LUNA_PLATFORM_SSE4)
			__m128i V1 = _mm_castps_si128(V);
			*y = static_cast<uint32>(_mm_extract_epi32(V1, 1));
#elif defined(LUNA_PLATFORM_SSE2)
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(1, 1, 1, 1));
			_mm_store_ss(reinterpret_cast<float32 *>(y), vResult);
#endif
		}

		// Store the Z component into a 32 bit integer locaCantion in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetIntZPtr(uint32 *z, vec_float_p1_t V)
		{
			luassert(z != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
...
#elif defined(LUNA_PLATFORM_SSE4)
			__m128i V1 = _mm_castps_si128(V);
			*z = static_cast<uint32>(_mm_extract_epi32(V1, 2));
#elif defined(LUNA_PLATFORM_SSE2)
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(2, 2, 2, 2));
			_mm_store_ss(reinterpret_cast<float32 *>(z), vResult);
#endif
		}

		// Store the W component into a 32 bit integer location in memory.

		inline void LUNA_SIMD_CALLCONV VectorGetIntWPtr(uint32 *w, vec_float_p1_t V)
		{
			luassert(w != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
...
#elif defined(LUNA_PLATFORM_SSE4)
			__m128i V1 = _mm_castps_si128(V);
			*w = static_cast<uint32>(_mm_extract_epi32(V1, 3));
#elif defined(LUNA_PLATFORM_SSE2)
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(3, 3, 3, 3));
			_mm_store_ss(reinterpret_cast<float32 *>(w), vResult);
#endif
		}
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetByIndex(vec_float_p1_t V, float32 f, size_t i)
		{
			luassert(i < 4);
			vec_f32_t U;
			U.v = V;
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetX(vec_float_p1_t V, float32 x)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetY(vec_float_p1_t V, float32 y)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vsetq_lane_f32(y, V, 1);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vResult = _mm_set_ss(y);
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetZ(vec_float_p1_t V, float32 z)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vsetq_lane_f32(z, V, 2);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vResult = _mm_set_ss(z);
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetW(vec_float_p1_t V, float32 w)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vsetq_lane_f32(w, V, 3);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vResult = _mm_set_ss(w);
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetByIndexPtr(vec_float_p1_t V, const float32 *f, size_t i)
		{
			luassert(f != nullptr);
			luassert(i < 4);
			vec_f32_t U;
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetXPtr(vec_float_p1_t V, const float32 *x)
		{
			luassert(x != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetYPtr(vec_float_p1_t V, const float32 *y)
		{
			luassert(y != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetZPtr(vec_float_p1_t V, const float32 *z)
		{
			luassert(z != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetWPtr(vec_float_p1_t V, const float32 *w)
		{
			luassert(w != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntByIndex(vec_float_p1_t V, uint32 x, size_t i)
		{
			luassert(i < 4);
			vec_u32_t tmp;
			tmp.v = V;
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntX(vec_float_p1_t V, uint32 x)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntY(vec_float_p1_t V, uint32 y)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntZ(vec_float_p1_t V, uint32 z)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntW(vec_float_p1_t V, uint32 w)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntByIndexPtr(vec_float_p1_t V, const uint32 *x, size_t i)
		{
			luassert(x != nullptr);
			luassert(i < 4);
			vec_u32_t tmp;
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntXPtr(vec_float_p1_t V, const uint32 *x)
		{
			luassert(x != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
			return vld1q_lane_u32(x, *reinterpret_cast<const uint32x4_t *>(&V), 0);
#elif defined(LUNA_PLATFORM_SSE2)
			vec_float_t vTemp = _mm_load_ss(reinterpret_cast<const float32 *>(x));
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntYPtr(vec_float_p1_t V, const uint32 *y)
		{
			luassert(y != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
			...
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(3, 2, 0, 1));
			// Convert input to vector
			vec_float_t vTemp = _mm_load_ss(reinterpret_cast<const float32 *>(y));
			// Replace the x component
			vResult = _mm_move_ss(vResult, vTemp);
			// Swap y and x again
			vResult = LUNA_SIMD_PERMUTE_PS(vResult, _MM_SHUFFLE(3, 2, 0, 1));
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntZPtr(vec_float_p1_t V, const uint32 *z)
		{
			luassert(z != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
			...
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(3, 0, 1, 2));
			// Convert input to vector
			vec_float_t vTemp = _mm_load_ss(reinterpret_cast<const float32 *>(z));
			// Replace the x component
			vResult = _mm_move_ss(vResult, vTemp);
			// Swap z and x again
			vResult = LUNA_SIMD_PERMUTE_PS(vResult, _MM_SHUFFLE(3, 0, 1, 2));
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorSetIntWPtr(vec_float_p1_t V, const uint32 *w)
		{
			luassert(w != nullptr);
#if defined(LUNA_PLATFORM_ARM_NEON)
			...
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(0, 2, 1, 3));
			// Convert input to vector
			vec_float_t vTemp = _mm_load_ss(reinterpret_cast<const float32 *>(w));
			// Replace the x component
			vResult = _mm_move_ss(vResult, vTemp);
			// Swap w and x again
			vResult = LUNA_SIMD_PERMUTE_PS(vResult, _MM_SHUFFLE(0, 2, 1, 3));
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			static const uint32 ControlElement[4] =
			{
...
#else
			auto aPtr = reinterpret_cast<const uint32*>(&V);
		...
		)
		{
			...
			const uint32 *aPtr[2];
			aPtr[0] = reinterpret_cast<const uint32*>(&V1);
			aPtr[1] = reinterpret_cast<const uint32*>(&V2);

			vec_float_t Result;
			auto pWork = reinterpret_cast<uint32*>(&Result);

			const uint32 i0 = PermuteX & 3;
			const uint32 vi0 = PermuteX >> 2;
			pWork[0] = aPtr[vi0][i0];

			const uint32 i1 = PermuteY & 3;
			const uint32 vi1 = PermuteY >> 2;
			pWork[1] = aPtr[vi1][i1];

			const uint32 i2 = PermuteZ & 3;
			const uint32 vi2 = PermuteZ >> 2;
			pWork[2] = aPtr[vi2][i2];

			const uint32 i3 = PermuteW & 3;
			const uint32 vi3 = PermuteW >> 2;
			pWork[3] = aPtr[vi3][i3];
...
#else
			vec_float    ControlVector;
			const uint32  ControlElement[] =
			{
				g_select_0,
				g_select_1
			};
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorShiftLeft(vec_float_p1_t V1, vec_float_p1_t V2, uint32 Elements)
		{
			luassert(Elements < 4);
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorRotateLeft(vec_float_p1_t V, uint32 Elements)
		{
			luassert(Elements < 4);
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorRotateRight(vec_float_p1_t V, uint32 Elements)
		{
			luassert(Elements < 4);
		...
		inline vec_float_t LUNA_SIMD_CALLCONV VectorInsert(vec_float_p1_t VD, vec_float_p1_t VS, uint32 VSLeftRotateElements,
		...
		)
		{
			...
			uint32 r = vget_lane_u32(vTemp.val[1], 1);
			uint32 CR = 0;
			if (r == 0xFFFFFFFFU)
			{
		...
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			vec_float vDelta = vsubq_f32(V1, V2);
		...
		)
		{
			...
			vec_float vTemp1 = vcleq_f32(V, Bounds);
			// Negate the bounds
			vec_float vTemp2 = vnegq_f32(Bounds);
		...
		namespace Internal
		{
			...
			inline float32 round_to_nearest(float32 x)
			{
				float32 i = floorf(x);
				x -= i;
				if (x < 0.5f)
...
#pragma float_control(precise, on)
		...
		)
		{
			...
			vec_float vResult = vbslq_f32(mask, R1, V);
			return vResult;
#endif
#elif defined(LUNA_PLATFORM_SSE4)
...
#pragma float_control(pop)
		...
		)
		{
			...
			vec_float vResult = vcvtq_f32_s32(vInt);
			...
			// Convert to int and back to float32 for rounding with truncation
		...
		)
		{
			...
			int32x4_t vInt = vcvtq_s32_f32(V);
			vec_float vResult = vcvtq_f32_s32(vInt);
			vec_float vLarger = vcgtq_f32(vResult, V);
			// 0 -> 0, 0xffffffff -> -1.0f
		...
		)
		{
			...
			int32x4_t vInt = vcvtq_s32_f32(V);
			vec_float vResult = vcvtq_f32_s32(vInt);
			vec_float vSmaller = vcltq_f32(vResult, V);
			// 0 -> 0, 0xffffffff -> -1.0f
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			// Set <0 to 0
			vec_float vResult = vmaxq_f32(V, vdupq_n_f32(0));
			// Set>1 to 1
		...
		)
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
#if defined(_M_ARM64) || defined(_M_HYBRID_X86_ARM64)
			vec_float vTemp = vpaddq_f32(V, V);
			...
			vec_float vTemp = _mm_hadd_ps(V, V);
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			// Adjust the angles
			vec_float vResult = vaddq_f32(V1, V2);
			// Less than Pi?
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			// Adjust the angles
			vec_float vResult = vsubq_f32(V1, V2);
			// Less than Pi?
			uint32x4_t vOffset = vcltq_f32(vResult, g_NegativePi);
			vOffset = vandq_u32(vOffset, g_TwoPi);
			// Add 2Pi to all entries less than -Pi
		...
		)
		{
			...
			vec_float VEqualsInfinity = VectorEqualInt(V, g_Infinity.v);
			vec_float VEqualsZero = VectorEqual(V, vdupq_n_f32(0));
			vec_float Result = vmulq_f32(V, S1);
			vec_float Select = VectorEqualInt(VEqualsInfinity, VEqualsZero);
		...
		)
		{
			...
			vec_float VEqualsInfinity = VectorEqualInt(V, g_Infinity.v);
			vec_float VEqualsZero = VectorEqual(V, vdupq_n_f32(0));
			vec_float Result = vmulq_f32(V, S3);
			vec_float Select = VectorEqualInt(VEqualsInfinity, VEqualsZero);
			return VectorSelect(V, Result, Select);
#elif defined(LUNA_PLATFORM_SSE2)
			return _mm_sqrt_ps(V);
...
//------------------------------------------------------------------------------
		...
		)
		{
			...
			return vResult.v;
#elif defined(LUNA_PLATFORM_SSE2)
			__declspec(align(16)) float32 a[4];
			__declspec(align(16)) float32 b[4];
			_mm_store_ps(a, V1);
			_mm_store_ps(b, V2);
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			vec_float vResult = VectorDivide(V1, V2);
		...
		)
		{
			...
			vec_float vResult = vmulq_f32(Angles, g_ReciprocalTwoPi);
	...
	// Force the value within the bounds of pi
			...
			const vec_float SC1 = g_SinCoefficients1;
			const vec_float SC0 = g_SinCoefficients0;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(SC0), 1);
			vec_float Result = vmlaq_lane_f32(vConstants, x2, vget_low_f32(SC1), 0);
	...
	// Map V to x in [-pi,pi].
			...
			// Compute polynomial approximation
			const vec_float CC1 = g_CosCoefficients1;
			const vec_float CC0 = g_CosCoefficients0;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(CC0), 1);
			vec_float Result = vmlaq_lane_f32(vConstants, x2, vget_low_f32(CC1), 0);
	...
	// Force the value within the bounds of pi
		...
		)
		{
			...
			vec_float_t TwoDivPi = VectorSplatW(TanConstants.v);

			vec_float_t Zero = VectorZero();

			vec_float_t C0 = VectorSplatX(TanConstants.v);
			vec_float_t C1 = VectorSplatY(TanConstants.v);
			vec_float_t Epsilon = VectorSplatZ(TanConstants.v);
			...
			{
				VB.vector4_u32[i] = static_cast<uint32>(VB.vector4_f32[i]);
			}
#endif

			vec_float_t VC2 = VectorMultiply(VC, VC);

			vec_float_t T7 = VectorSplatW(TanCoefficients1.v);
			vec_float_t T6 = VectorSplatZ(TanCoefficients1.v);
			vec_float_t T4 = VectorSplatX(TanCoefficients1.v);
			vec_float_t T3 = VectorSplatW(TanCoefficients0.v);
			vec_float_t T5 = VectorSplatY(TanCoefficients1.v);
			vec_float_t T2 = VectorSplatZ(TanCoefficients0.v);
			vec_float_t T1 = VectorSplatY(TanCoefficients0.v);
			vec_float_t T0 = VectorSplatX(TanCoefficients0.v);
		...
		)
		{
			...
			vec_float V1 = vmlaq_f32(g_NegativeOne.v, V, Scale.v);
			vec_float V2 = vmlsq_f32(g_NegativeOne.v, V, Scale.v);
			vec_float E1 = VectorExp(V1);
			vec_float E2 = VectorExp(V2);
		...
		)
		{
			...
			vec_float E = vmulq_f32(V, Scale.v);
			E = VectorExp(E);
		...
		)
		{
			...
			// Compute polynomial approximation
			const vec_float AC1 = g_ArcCoefficients1;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(AC1), 0);
			vec_float t0 = vmlaq_lane_f32(vConstants, x, vget_high_f32(AC1), 1);
			...
			const vec_float AC0 = g_ArcCoefficients0;
		...
		)
		{
			...
			// Compute polynomial approximation
			const vec_float TC1 = g_ATanCoefficients1;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(TC1), 0);
			vec_float Result = vmlaq_lane_f32(vConstants, x2, vget_high_f32(TC1), 1);
			...
			const vec_float TC0 = g_ATanCoefficients0;
		...
		)
		{
			...
			vec_float_t Zero = VectorZero();
			vec_float_t ATanResultValid = VectorTrueInt();

			vec_float_t Pi = VectorSplatX(ATan2Constants);
			vec_float_t PiOverTwo = VectorSplatY(ATan2Constants);
			vec_float_t PiOverFour = VectorSplatZ(ATan2Constants);
			vec_float_t ThreePiOverFour = VectorSplatW(ATan2Constants);
	...
	// Force the value within the bounds of pi
			...
			// Compute polynomial approximation
			const vec_float SEC = g_SinCoefficients1;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(SEC), 0);
			vec_float Result = vmlaq_lane_f32(vConstants, x2, vget_high_f32(SEC), 1);
	...
	// Map V to x in [-pi,pi].
			...
			// Compute polynomial approximation
			const vec_float CEC = g_CosCoefficients1;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(CEC), 0);
			vec_float Result = vmlaq_lane_f32(vConstants, x2, vget_high_f32(CEC), 1);
	...
	// Force the value within the bounds of pi
		...
		)
		{
			...
			vec_float_t OneOverPi = VectorSplatW(g_TanEstCoefficients.v);
			...
			vec_float_t T0 = VectorSplatX(g_TanEstCoefficients.v);
			vec_float_t T1 = VectorSplatY(g_TanEstCoefficients.v);
			vec_float_t T2 = VectorSplatZ(g_TanEstCoefficients.v);
		...
		)
		{
			...
			// Compute polynomial approximation
			const vec_float AEC = g_ArcEstCoefficients;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(AEC), 0);
			vec_float t0 = vmlaq_lane_f32(vConstants, x, vget_high_f32(AEC), 1);
		...
		)
		{
			...
			// Compute polynomial approximation
			const vec_float AEC = g_ATanEstCoefficients1;
			vec_float vConstants = vdupq_lane_f32(vget_high_f32(AEC), 0);
			vec_float Result = vmlaq_lane_f32(vConstants, x2, vget_high_f32(AEC), 1);
		...
		)
		{
			...
			const vec_float_t Zero = VectorZero();
			vec_float_t ATanResultValid = VectorTrueInt();
		...
		)
		{
			...
			float32 p0 = 2.0f * t3 - 3.0f * t2 + 1.0f;
			float32 t0 = t3 - 2.0f * t2 + t;
			float32 p1 = -2.0f * t3 + 3.0f * t2;
			float32 t1 = t3 - t2;

			vec_float vResult = vmulq_n_f32(Position0, p0);
		...
		)
		{
			...
			vec_float T2 = vmulq_f32(T, T);
			vec_float T3 = vmulq_f32(T, T2);
			...
			vec_float vResult = vmulq_lane_f32(Position0, vget_low_f32(T3), 0); // T3[0]
		...
		)
		{
			...
			float32 p0 = (-t3 + 2.0f * t2 - t) * 0.5f;
			float32 p1 = (3.0f * t3 - 5.0f * t2 + 2.0f) * 0.5f;
			float32 p2 = (-3.0f * t3 + 4.0f * t2 + t) * 0.5f;
			float32 p3 = (t3 - t2) * 0.5f;

			vec_float P1 = vmulq_n_f32(Position1, p1);
			vec_float P0 = vmlaq_n_f32(P1, Position0, p0);
			vec_float P3 = vmulq_n_f32(Position3, p3);
			vec_float P2 = vmlaq_n_f32(P3, Position2, p2);
			P0 = vaddq_f32(P0, P2);
			return P0;
#elif defined(LUNA_PLATFORM_SSE2)
			float32 t2 = t * t;
		...
		)
		{
			...
			vec_float vResult = vaddq_f32(T2, T2);
			...
			vec_float vTemp = vmulq_f32(T3, Catmul3);
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			vec_float R1 = vsubq_f32(Position1, Position0);
			vec_float R2 = vsubq_f32(Position2, Position0);
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector2EqualR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector2EqualIntR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector2GreaterR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector2GreaterOrEqualR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
...
#elif defined(LUNA_PLATFORM_SSE3)
			vec_float vDot = _mm_mul_ps(V1, V2);
	...
	// Swap x and y
		...
		)
		{
			...
			return vcombine_f32(vTemp, vTemp);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vTemp = _mm_dp_ps(V, V, 0x3f);
			return _mm_rsqrt_ps(vTemp);
#elif defined(LUNA_PLATFORM_SSE3)
			vec_float vLengthSq = _mm_mul_ps(V, V);
			vec_float vTemp = _mm_hadd_ps(vLengthSq, vLengthSq);
...
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vTemp = _mm_dp_ps(V, V, 0x3f);
			vec_float vLengthSq = _mm_sqrt_ps(vTemp);
		...
		)
		{
			...
			return vcombine_f32(Result, Result);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vLengthSq = _mm_dp_ps(V, V, 0x3f);
			// Prepare for the division
			vec_float vResult = _mm_sqrt_ps(vLengthSq);
			// Create zero with a single instruction
			vec_float vZeroMask = _mm_setzero_ps();
			...
			vec_float vTemp1 = _mm_andnot_ps(vLengthSq, g_QNaN);
			vec_float vTemp2 = _mm_and_ps(vResult, vLengthSq);
		...
		{
			vec_float_t ClampMax = VectorReplicate(LengthMax);
			vec_float_t ClampMin = VectorReplicate(LengthMin);
		...
		(
			vec_float_p1_t Incident,
			vec_float_p1_t Normal,
			float32    RefractionIndex
		)
		{
			vec_float_t Index = VectorReplicate(RefractionIndex);
	...
	// Get the 2D dot product of Incident-Normal
		...
		)
		{
			...
			vec_float V1 = VectorSubtract(Line1Point2, Line1Point1);
			vec_float V2 = VectorSubtract(Line2Point2, Line2Point1);
			vec_float V3 = VectorSubtract(Line1Point1, Line2Point1);

			vec_float C1 = Vector2Cross(V1, V2);
			vec_float C2 = Vector2Cross(V2, V3);

			vec_float Result;
			const vec_float Zero = VectorZero();
			...
			else
			{
				...
				vec_float Scale = VectorReciprocal(C1);
		...
		inline float32* LUNA_SIMD_CALLCONV Vector2TransformStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
		...
		)
		{
			...
			const vec_float row0 = M.r[0];
			const vec_float row1 = M.r[1];
			const vec_float row3 = M.r[3];
			...
			if (four > 0)
			{
				if ((InputStride == 8) && (OutputStride == 16))
				{
					for (size_t j = 0; j < four; ++j)
					{
						...
						vec_float vResult0 = vmlaq_lane_f32(vdupq_lane_f32(r3, 0), V.val[0], r, 0); // Ax+M
						vec_float vResult1 = vmlaq_lane_f32(vdupq_lane_f32(r3, 1), V.val[0], r, 1); // Bx+N

						__prefetch(pInputVector);

						r3 = vget_high_f32(row3);
						r = vget_high_f32(row0);
						vec_float vResult2 = vmlaq_lane_f32(vdupq_lane_f32(r3, 0), V.val[0], r, 0); // Cx+O
						vec_float vResult3 = vmlaq_lane_f32(vdupq_lane_f32(r3, 1), V.val[0], r, 1); // Dx+P
			...
			for (; i < VectorCount; i++)
			{
				...
				vec_float vResult = vmlaq_lane_f32(row3, row0, V, 0); // X
		...
		{
			vec_float_t Y = VectorSplatY(V);
			vec_float_t X = VectorSplatX(V);

			vec_float_t Result = VectorMultiplyAdd(Y, M.r[1], M.r[3]);
			Result = VectorMultiplyAdd(X, M.r[0], Result);

			vec_float_t W = VectorSplatW(Result);
		...
		inline float32* LUNA_SIMD_CALLCONV Vector2TransformCoordStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
			...
			if (four > 0)
			{
				if ((InputStride == 8) && (OutputStride == 8))
				{
					for (size_t j = 0; j < four; ++j)
					{
						...
						r3 = vget_high_f32(row3);
						r = vget_high_f32(row0);
						vec_float W = vmlaq_lane_f32(vdupq_lane_f32(r3, 1), V.val[0], r, 1); // Dx+P
		...
		inline float32* LUNA_SIMD_CALLCONV Vector2TransformNormalStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
		...
		)
		{
			...
			if (four > 0)
			{
				if ((InputStride == 8) && (OutputStride == 8))
				{
					for (size_t j = 0; j < four; ++j)
					{
						...
						float32x2_t r = vget_low_f32(row0);
						vec_float vResult0 = vmulq_lane_f32(V.val[0], r, 0); // Ax
						vec_float vResult1 = vmulq_lane_f32(V.val[0], r, 1); // Bx
			...
			for (; i < VectorCount; i++)
			{
				...
				vec_float vResult = vmulq_lane_f32(row0, V, 0); // X
				vResult = vmlaq_lane_f32(vResult, row1, V, 1); // Y
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector3EqualR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		{
			...
			int8x8x2_t vTemp = vzip_u8(vget_low_u8(vResult), vget_high_u8(vResult));
			vTemp = vzip_u16(vTemp.val[0], vTemp.val[1]);
			uint32 r = vget_lane_u32(vTemp.val[1], 1) & 0xFFFFFFU;
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector3EqualIntR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector3GreaterR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector3GreaterOrEqualR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
...
#elif defined(LUNA_PLATFORM_SSE3)
			vec_float vTemp = _mm_mul_ps(V1, V2);
		...
		)
		{
			...
			vec_float vResult = vmulq_f32(vcombine_f32(v1yx, v1xy), vcombine_f32(v2zz, v2yx));
	...
	// y1,z1,x1,w1
...
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vTemp = _mm_dp_ps(V, V, 0x7f);
			return _mm_rsqrt_ps(vTemp);
#elif defined(LUNA_PLATFORM_SSE3)
			vec_float vLengthSq = _mm_mul_ps(V, V);
		...
		)
		{
			...
			v2 = vmul_f32(S1, R1);
			// normalize
			vec_float vResult = vmulq_f32(V, vcombine_f32(v2, v2));
...
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vLengthSq = _mm_dp_ps(V, V, 0x7f);
			// Prepare for the division
			vec_float vResult = _mm_sqrt_ps(vLengthSq);
			// Create zero with a single instruction
			vec_float vZeroMask = _mm_setzero_ps();
		...
		)
		{
			...
			luassert(Vector3GreaterOrEqual(LengthMin, VectorZero()));
			luassert(Vector3GreaterOrEqual(LengthMax, VectorZero()));
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			vec_float IDotN = Vector3Dot(Incident, Normal);
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			float32x2_t VL = vget_low_f32(V);
			vec_float vResult = vmlaq_lane_f32(M.r[3], M.r[0], VL, 0); // X
...
#pragma prefast(disable : 26015 26019, "PREfast noise: Esp:1307" )
		...
		inline float32* LUNA_SIMD_CALLCONV Vector3TransformStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
		...
		)
		{
			...
			for (; i < VectorCount; i++)
			{
				...
				vec_float vResult = vmlaq_lane_f32(row3, row0, VL, 0); // X
			...
			if (!(reinterpret_cast<uintptr_t>(pOutputStream) & 0xF) && !(OutputStride & 0xF))
			{
				...
				for (; i < VectorCount; ++i)
				{
					vec_float_t V = load_float3(reinterpret_cast<const float32*>(pInputVector));
					pInputVector += InputStride;
...
#pragma prefast(disable : 26015 26019, "PREfast noise: Esp:1307" )
		...
		inline float32* LUNA_SIMD_CALLCONV Vector3TransformCoordStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
		...
		)
		{
			...
			for (; i < VectorCount; i++)
			{
				...
				vec_float W = vdupq_lane_f32(VH, 1);
				...
				if (InputStride == 12)
				{
					...
					else
					{
						...
						for (size_t j = 0; j < four; ++j)
						{
							...
							vTemp = _mm_div_ps(vTemp, W);
							store_float3(reinterpret_cast<float32*>(pOutputVector), vTemp);
							pOutputVector += OutputStride;
...
#if defined(LUNA_PLATFORM_ARM_NEON)
			float32x2_t VL = vget_low_f32(V);
			vec_float vResult = vmulq_lane_f32(M.r[0], VL, 0); // X
			vResult = vmlaq_lane_f32(vResult, M.r[1], VL, 1); // Y
			return vmlaq_lane_f32(vResult, M.r[2], vget_high_f32(V), 0); // Z
#elif defined(LUNA_PLATFORM_SSE2)
			vec_float_t vResult = LUNA_SIMD_PERMUTE_PS(V, _MM_SHUFFLE(0, 0, 0, 0));
...
#pragma prefast(disable : 26015 26019, "PREfast noise: Esp:1307" )
		...
		inline float32* LUNA_SIMD_CALLCONV Vector3TransformNormalStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
		...
		)
		{
			...
			if (four > 0)
			{
				if ((InputStride == 12) && (OutputStride == 12))
				{
					for (size_t j = 0; j < four; ++j)
					{
						...
						r = vget_high_f32(row0);
						vec_float vResult2 = vmulq_lane_f32(V.val[0], r, 0); // Cx
			...
			for (; i < VectorCount; i++)
			{
				...
				vec_float vResult = vmulq_lane_f32(row0, VL, 0); // X
				vResult = vmlaq_lane_f32(vResult, row1, VL, 1); // Y
				vResult = vmlaq_lane_f32(vResult, row2, VH, 0); // Z
...
#pragma prefast(pop)
		...
		(
			...
			float32    ViewportMinZ,
			float32    ViewportMaxZ,
			mat_float_p1_t Projection,
			mat_float_p2_t View,
			mat_float_p2_t World
		)
		{
			const float32 HalfViewportWidth = ViewportWidth * 0.5f;
			const float32 HalfViewportHeight = ViewportHeight * 0.5f;

			vec_float_t Scale = VectorSet(HalfViewportWidth, -HalfViewportHeight, ViewportMaxZ - ViewportMinZ, 0.0f);
			vec_float_t Offset = VectorSet(ViewportX + HalfViewportWidth, ViewportY + HalfViewportHeight, ViewportMinZ, 0.0f);
...
#pragma prefast(disable : 26015 26019, "PREfast noise: Esp:1307" )
		...
		inline float32* LUNA_SIMD_CALLCONV Vector3ProjectStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
		...
		)
		{
			...
			if (four > 0)
			{
				if ((InputStride == 12) && (OutputStride == 12))
				{
					vec_float ScaleX = vdupq_n_f32(HalfViewportWidth);
					vec_float ScaleY = vdupq_n_f32(-HalfViewportHeight);
					vec_float ScaleZ = vdupq_n_f32(ViewportMaxZ - ViewportMinZ);

					vec_float OffsetX = vdupq_n_f32(ViewportX + HalfViewportWidth);
					vec_float OffsetY = vdupq_n_f32(ViewportY + HalfViewportHeight);
					vec_float OffsetZ = vdupq_n_f32(ViewportMinZ);
			...
			if (i < VectorCount)
			{
				vec_float Scale = VectorSet(HalfViewportWidth, -HalfViewportHeight, ViewportMaxZ - ViewportMinZ, 1.0f);
				vec_float Offset = VectorSet(ViewportX + HalfViewportWidth, ViewportY + HalfViewportHeight, ViewportMinZ, 0.0f);
				...
				for (; i < VectorCount; i++)
				{
					...
					vec_float vResult = vmlaq_lane_f32(Transform.r[3], Transform.r[0], VL, 0); // X
			...
			vec_float_t Scale = VectorSet(HalfViewportWidth, -HalfViewportHeight, ViewportMaxZ - ViewportMinZ, 1.0f);
			vec_float_t Offset = VectorSet(ViewportX + HalfViewportWidth, ViewportY + HalfViewportHeight, ViewportMinZ, 0.0f);
...
#pragma prefast(pop)
		...
		)
		{
			...
			vec_float_t Scale = VectorSet(ViewportWidth * 0.5f, -ViewportHeight * 0.5f, ViewportMaxZ - ViewportMinZ, 1.0f);
			Scale = VectorReciprocal(Scale);

			vec_float_t Offset = VectorSet(-ViewportX, -ViewportY, -ViewportMinZ, 0.0f);
...
#pragma prefast(disable : 26015 26019, "PREfast noise: Esp:1307" )
		...
		inline float32* LUNA_SIMD_CALLCONV Vector3UnprojectStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
			...
			mat_float_p2_t       World)
		{
			...
			float32 sx = 1.f / (ViewportWidth * 0.5f);
			float32 sy = 1.f / (-ViewportHeight * 0.5f);
			float32 sz = 1.f / (ViewportMaxZ - ViewportMinZ);

			float32 ox = (-ViewportX * sx) - 1.f;
			float32 oy = (-ViewportY * sy) + 1.f;
			float32 oz = (-ViewportMinZ * sz);
			...
			if (four > 0)
			{
				if ((InputStride == 12) && (OutputStride == 12))
				{
					for (size_t j = 0; j < four; ++j)
					{
						...
						vec_float ScaleX = vdupq_n_f32(sx);
						vec_float OffsetX = vdupq_n_f32(ox);
						vec_float VX = vmlaq_f32(OffsetX, ScaleX, V.val[0]);

						float32x2_t r3 = vget_low_f32(Transform.r[3]);
						float32x2_t r = vget_low_f32(Transform.r[0]);
						vec_float vResult0 = vmlaq_lane_f32(vdupq_lane_f32(r3, 0), VX, r, 0); // Ax+M
						vec_float vResult1 = vmlaq_lane_f32(vdupq_lane_f32(r3, 1), VX, r, 1); // Bx+N

						__prefetch(pInputVector);

						r3 = vget_high_f32(Transform.r[3]);
						r = vget_high_f32(Transform.r[0]);
						vec_float vResult2 = vmlaq_lane_f32(vdupq_lane_f32(r3, 0), VX, r, 0); // Cx+O
						vec_float W = vmlaq_lane_f32(vdupq_lane_f32(r3, 1), VX, r, 1); // Dx+P

						__prefetch(pInputVector + g_cache_line_size);

						vec_float ScaleY = vdupq_n_f32(sy);
						vec_float OffsetY = vdupq_n_f32(oy);
						vec_float VY = vmlaq_f32(OffsetY, ScaleY, V.val[1]);
						...
						vec_float ScaleZ = vdupq_n_f32(sz);
						vec_float OffsetZ = vdupq_n_f32(oz);
						vec_float VZ = vmlaq_f32(OffsetZ, ScaleZ, V.val[2]);
			...
			if (i < VectorCount)
			{
				float32x2_t ScaleL = vcreate_f32(
					static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&sx))
					| (static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&sy)) << 32));
				float32x2_t ScaleH = vcreate_f32(static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&sz)));

				float32x2_t OffsetL = vcreate_f32(
					static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&ox))
					| (static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&oy)) << 32));
				float32x2_t OffsetH = vcreate_f32(static_cast<uint64_t>(*reinterpret_cast<const uint32 *>(&oz)));
...
#pragma prefast(pop)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector4EqualR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector4EqualIntR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector4GreaterR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		inline uint32 LUNA_SIMD_CALLCONV Vector4GreaterOrEqualR
		(
			vec_float_p1_t V1,
			vec_float_p1_t V2
		)
		...
		)
		{
			...
			vec_float vResult = vmulq_f32(vTemp1, vTemp2);
	...
	// V2zwyz * V3wzwy
		...
		)
		{
			...
			return vcombine_f32(v2, v2);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vTemp = _mm_dp_ps(V, V, 0xff);
			return _mm_rsqrt_ps(vTemp);
#elif defined(LUNA_PLATFORM_SSE3)
			vec_float vLengthSq = _mm_mul_ps(V, V);
			vLengthSq = _mm_hadd_ps(vLengthSq, vLengthSq);
		...
		)
		{
			...
			return vbslq_f32(vcombine_f32(VEqualsInf, VEqualsInf), g_QNaN, vResult);
#elif defined(LUNA_PLATFORM_SSE4)
			vec_float vLengthSq = _mm_dp_ps(V, V, 0xff);
			// Prepare for the division
			vec_float vResult = _mm_sqrt_ps(vLengthSq);
			// Create zero with a single instruction
			vec_float vZeroMask = _mm_setzero_ps();
		...
		)
		{
			...
			luassert(Vector4GreaterOrEqual(LengthMin, VectorZero()));
			luassert(Vector4GreaterOrEqual(LengthMax, VectorZero()));
		...
		{
#if defined(LUNA_PLATFORM_ARM_NEON)
			vec_float IDotN = Vector4Dot(Incident, Normal);
		...
		inline float32* LUNA_SIMD_CALLCONV Vector4TransformStream
		(
			float32*       pOutputStream,
			size_t          OutputStride,
			const float32* pInputStream,
		...
		)
		{
			...
			if (four > 0)
			{
				if ((InputStride == 16) && (OutputStride == 16))
				{
					for (size_t j = 0; j < four; ++j)
					{
						...
						r = vget_high_f32(row0);
						vec_float vResult2 = vmulq_lane_f32(V.val[0], r, 0); // Cx
						vec_float vResult3 = vmulq_lane_f32(V.val[0], r, 1); // Dx
			...
			for (; i < VectorCount; i++)
			{
				vec_float V = vld1q_f32(reinterpret_cast<const float*>(pInputVector));
				pInputVector += InputStride;
