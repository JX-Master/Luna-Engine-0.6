...
namespace Luna
{
	namespace EasyDraw
	{
		...
		struct IDrawListRenderer : public IObject
		{
			...
			virtual void add_draw_calls(IDrawList* draw_list, u32 first, u32 num_draw_calls) = 0;
			...
			virtual RV render(Gfx::ICommandBuffer* target_cmd_buffer, Gfx::IResource* rt, u32 width, u32 height) = 0;
		};
	}
}